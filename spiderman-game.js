...
var RESOURCES = {
	"JUMP"               : "images/jump2.png",
	"RUNNING_CHANGE_STEP": "images/running-change-step2.png",
	"RUNNING_LEFT_STEP"  : "images/running-left-step2.png",
	"RUNNING_RIGHT_STEP" : "images/running-right-step2.png",
	"SHOOT_CHANGE_STEP"  : "images/shoot-change-step.png",
	"SHOOT_JUMP"         : "images/shoot-jump2.png",
	"SHOOT_LEFT-STEP"    : "images/shoot-left-step2.png",
	"SHOOT_RIGHT-STEP"   : "images/shoot-right-step2.png",
	"SHOOT"              : "images/shoot2.png",
	"STANDING"           : "images/standing2.png",
	"WEB_PROJECTILE"     : "images/web.png",
	"BACKGROUND"         : "images/back_ground2.jpg",
...
SpiderMan.prototype.handleHitWithProjectile = function(projectile) {
	if (projectile.name != "WEB") {
		...
		var audio = new Audio('audio/hurt.mp3');
  		audio.play();
	}
}
...
SpiderMan.prototype.shoot = function(img) {
	...
	var audio = new Audio('audio/shooting-web2.mp3');
  	audio.play();
	...
	web.handleHitWithCharacter = function(character) {
		// somtimes projectile is being hit by the spiderman ON launch...while he is running
...
function Roof(game, x, y) {
	...
	this.height = Math.round(Math.random() * 50) + 150;
	...
	// 70% chance?
	var shouldSpawnEnemy = Math.round(Math.random() * 100) >= 25;
	if (shouldSpawnEnemy) {
